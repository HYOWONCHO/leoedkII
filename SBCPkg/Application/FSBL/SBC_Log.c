...
static EFI_HANDLE *write_log_handle;
  ...
  )
{
    ...
    [[maybe_unused]] UINTN final_ascii_len;
    ...
    //final_ascii_len = remove_all_space(wrlog_ptr, AsciiConvertedLen); // Pass converted length, not full buffer size
